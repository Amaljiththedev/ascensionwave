...
<BentoCard
  ...
  description={
    <span>
      Explore our comprehensive design and development solutions tailored to enhance your brand's presence and impact.
    </span>
  }
  className="sm:col-span-1 sm:row-span-2"
  gradient="bg-gradient-to-br from-red-500 via-fuchsia-500 to-red-500 opacity-[0.3] blur-3xl"
>
  <div className="group relative flex cursor-pointer flex-col justify-end rounded-md bg-zinc-950 p-2 text-2xl tracking-tight text-gray-100 md:text-4xl">
    <div className="font-light">Partner with Us</div>
    <div className="-mt-2 font-bold">Delivering Excellence</div>
    ...
    <div className="absolute right-2 top-2 h-2 w-2 rounded-full bg-black opacity-50 transition-all duration-700 group-hover:opacity-25" />
  </div>
</BentoCard>
...
function LinearGradient() {
  return (
    <BentoCard
      ...
      description="We specialize in creating customized web solutions that cater to your specific business needs, ensuring a seamless and engaging user experience."
...
export default function Gradient() {
  return (
    <div className="bg-zinc-950 p-4">
      <div className="max-w-4xl mx-auto grid grid-cols-1 gap-4 text-black sm:grid-cols-3 lg:grid-cols-3">
        <GetGradient />
        <LinearGradient />
        <RadialGradient />
        <ConicGradient />
